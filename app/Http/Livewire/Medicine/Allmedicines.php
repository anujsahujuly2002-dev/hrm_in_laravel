...
class Allmedicines extends Component
{
    ...
    public $pageId=0;
    public $name,$code, $potency, $medicine_type, $stock, $rate,$rateselling,$disease_name;
    public $medstockId=0;
    public $diseases = [];
    ...
    public function create()
    {
        ...
        if($this->val_id){
            Medicine::where('id', $this->val_id)->update([
                ...
                'stock' => $this->stock,
                'price' => $this->rate,
                'purchase_price' => $this->rateselling,
                'disease_name' => $this->disease_name
            ]);
        }
        else{
            $medicine = new Medicine;
            $medicine->name= ucwords($this->name);
            $medicine->code= $this->code;
            $medicine->unit= $this->potency;
            $medicine->med_type= $this->medicine_type;
            $medicine->stock= $this->stock;
            $medicine->price= $this->rate;
            $medicine->purchase_price= $this->rateselling;
            $medicine->disease_name = $this->disease_name;
            $medicine->save();
        }
    ...
    public function edit($id)
    {
        ...
        $this->rateselling = $data->purchase_price;
