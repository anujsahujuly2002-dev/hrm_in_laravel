            ...
            <div class="card-body">
                ...
                <form wire:submit.prevent="create" class="row">
                    ...
                    <div class="form-group col-md-12 mb-3">
                        ...
                        <select name="disease_name" wire:model.defer="disease_name" id="disease_name" class="form-control">
                    ...
                    <div class="form-group col-md-12 mb-3">
                        ...
                        <input type="number" step="0.01" name="rate" wire:model.defer="rate" placeholder="Purchase rate per unit" autocomplete="off" id="rate" class="form-control">
                        @error('rate')
                    ...
                    <div class="form-group col-md-12 mb-3">
                        ...
                        <input type="number" step="0.01" name="rateselling" wire:model.defer="rateselling" placeholder="Sell rate per unit" autocomplete="off" id="rateselling" class="form-control">
                        @error('rateselling')
                        <small class="text-danger">{{ $message }}</small><br>
                        @enderror
                        <!-- <span class="text-info">Sell rate will always change as per last purchase data.</span> -->
